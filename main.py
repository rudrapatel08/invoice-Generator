...
def generate_invoice():
    ...
    total = str(round(sum(item[3] for item in invoice_list),2))
...
qty_spinbox = tkinter.Spinbox(frame, from_=1.00, to=100.00)
...
price_spinbox = tkinter.Spinbox(frame, from_=0.00, to=500.00)
